    ...
    return (
        <div className = "bg-neutral-950 w-full pb-10 h-fit flex flex-col relative justify-center items-center overflow-x-hidden">
            ...
            <div className = "flex flex-row mb-40 w-full px-20 justify-center gap-6 hidden-animate">
                <div className = "relative group overflow-hidden bg-[#111111] border-[1px] w-1/2 border-neutral-700 rounded-lg py-10 px-6 flex flex-col">
            ...
            <div className = "flex flex-row mb-40 w-full px-20 justify-center gap-6 hidden-animate">
                <div className = "flex flex-row bg-[#111111] w-full border-[1px] border-neutral-700 rounded-lg py-10 px-6">
                    <div className = "w-5/12">
                        ...
                        <h1 className = "text-neutral-500 text-3xl">Friends are an important part of everyones life. Since the information you might want to share on Chronicle <span className = "text-neutral-200">might be sensitive</span>, your friends on Chronicle will show up anonymous, but if you feel a <span className = "text-neutral-200">real connection</span>, you'll have the chance to <span className = "text-neutral-200">find out each others identity</span> on our site.</h1>
                    </div>
                </div>
            </div>
        </div>

...
const FriendMessage = ({ message, image, name }) => {
    return (
        <div className="bg-[#111111] max-w-full rounded-lg p-2">
            <div className="flex flex-row items-start max-w-full">
                ...
                {/* Text container that wraps and takes up remaining space */}
                <div className="flex flex-col max-w-full ml-2">
                    <h1 className="text-neutral-400">{name}</h1>

                    {/* Message text container */}
                    <div className="text-neutral-400 break-words whitespace-normal overflow-hidden">
                        {message}
                    </div>
                </div>
            </div>
